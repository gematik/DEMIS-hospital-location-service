...
COPY --chown=$USERID:$GROUPID target/hospital-location-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="DEMIS Hospital-Location-Service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/hospital-location-service.git" \
